            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2">
                    <Tabs defaultValue="received" value={activeTab} onValueChange={setActiveTab} className="w-full">
                        ...
                        <TabsContent value="friends" className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {loading ? (
                                ...
                                friends.map(friend => (
                                    <Card key={friend.id} className="border-border/40 hover:border-primary/50 transition-colors cursor-pointer" onClick={() => router.push(`/profile/${friend.id}`)}>
