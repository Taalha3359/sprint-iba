            ...
            <div className="max-w-7xl mx-auto space-y-8">
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex gap-2">
                        <Button variant="outline" onClick={() => router.push("/operator/reports")}>
                            <Flag className="w-4 h-4 mr-2" />
                            View Reports
                        </Button>
                        <Button onClick={() => router.push("/operator/editor/new")}>
                                        ...
                                        {questions.map((q) => (
                                            <TableRow key={q.id}>
                                                ...
                                                <TableCell className="text-right space-x-2">
                                                    <Button variant="ghost" size="icon" onClick={() => router.push(`/operator/editor/${q.id}`)}>
