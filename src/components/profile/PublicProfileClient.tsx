...
const PublicProfileClient = ({ userId }: PublicProfileClientProps) => {
    const { user } = useAuth();
    ...
    return (
        <div className="container mx-auto px-6 py-8">
            <Button variant="ghost" className="w-fit mb-6" onClick={() => router.back()}>
                                ...
                                <div className="flex items-center justify-center md:justify-start gap-4 pt-2">
                                    {user && user.id !== userId && (
                                        <>
                                            ...
                                            <Button variant="outline" onClick={() => router.push(`/messages?userId=${userId}`)}>
